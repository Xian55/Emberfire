...
class LootDbEntryEditor :	public TableTemplateEditor
{
	enum Interface
	{
	};
	...
	enum Field
	{
		...
		LOTF_count_max,
		LOTF_condition1,
		LOTF_condition1_value1,
		LOTF_condition1_value2,
		LOTF_condition1_true,
		LOTF_condition2,
		LOTF_condition2_value1,
		LOTF_condition2_value2,
		LOTF_condition2_true,
	...
	public:
		LootDbEntryEditor(RenderObjectHolder& owner, const int id);
		virtual ~LootDbEntryEditor();
